...
(function(window,undefined){
	...
	validator.prototype={
		...
		result:function(){
			...
			if(o.get("target").find(".validator-input-error").length>0) result=false;
			return result;
		},
