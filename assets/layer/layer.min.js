...
! function(a, b) {
	...
	h.anim = ["layui-anim", "layui-anim-01", "layui-anim-02", "layui-anim-03", "layui-anim-04", "layui-anim-05", "layui-anim-06"], g.pt.config = {
		...
		return f.zIndex = g, b([f.shade ? '<div class="layui-layer-shade" id="layui-layer-shade' + d + '" times="' + d + '" style="' + ("z-index:" + (g - 1) + "; background-color:" + (f.shade[1] || "#000") + "; opacity:" + (f.shade[0] || f.shade) + "; filter:alpha(opacity=" + (100 * f.shade[0] || 100 * f.shade) + ");") + '"></div>' : "", 
		...
		a.vessel(j, function(d, e,f) {
			...
			$(".layui-layer-loading"+domSize).css({
				...
				"background-image": window.$$ ? "url(.."+$$("static/common/assets/layer/skin/default/loading-"+domSize+".gif") :""
			});
